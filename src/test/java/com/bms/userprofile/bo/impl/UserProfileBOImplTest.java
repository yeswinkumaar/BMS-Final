...
//	@Test
//	public void userNameAvailabilitySuccess_Test() throws Exception
//	{
...
//	}
//	@Test
//	public void userNameAvailabilityValidationFailure_Test() throws Exception
//	{
//		String username="mohan123";
//
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
...
//	
//	@Test
//	public void updateUserProfileValidationFailure_Test() throws Exception
//	{
//		
//
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
...
//	}
//	@Test
//	public void updateUserProfileInvalidCustomerId_Test() throws Exception
//	{
//		
//		mockUserProfile=new UserProfileRequest((long) 1, "vignesh123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","Y","Y","Y","Y");
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
//		 userProfileResponse.setHttpStatus(HttpStatus.BAD_REQUEST);
...
//	
//	@Test
//	public void updateUserProfileInvalidFlag_Test() throws Exception
//	{
//		
//		mockUserProfile=new UserProfileRequest((long) 1, "vignesh123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","N","N","N","Y");
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
//		 userProfileResponse.setHttpStatus(HttpStatus.BAD_REQUEST);
...
//	
//	@Test
//	public void updateUserProfilePasswordFailure_Test() throws Exception
//	{
//		
//		mockUserProfile=new UserProfileRequest((long) 1, "vignesh123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","Y","Y","Y","Y");
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
...
//	
//	@Test
//	public void updateUserProfilePasswordSuccess_Test() throws Exception
//	{
//		
//		mockUserProfile=new UserProfileRequest((long) 1, "viCKY$123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","N","N","Y","Y");
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
//		 userProfileResponse.setHttpStatus(HttpStatus.OK);
//		 userProfileResponse.setResponse("Invalid  Username OR Customer ID");
//		when(userProfileValidation.validateIndicator(mockUserProfile.getIsLoggedIn())).thenReturn(true);
...
//	
//	@Test
//	public void updateUserProfileSamePasswordFailure_Test() throws Exception
//	{
//		
//		mockUserProfile=new UserProfileRequest((long) 1, "viCKY$123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","N","N","Y","Y");
//		 UserProfileResponse userProfileResponse=new UserProfileResponse();
...
//		when(UserProfileUtil.checkPassword(cust.getPassword(), mockUserProfile.getPassWord())).thenReturn(true);
//		
//		UserProfileResponse result=userProfileBO.updateUserProfile(mockUserProfile);
//		assertEquals(userProfileResponse.getResponse(), result.getResponse());
//		
