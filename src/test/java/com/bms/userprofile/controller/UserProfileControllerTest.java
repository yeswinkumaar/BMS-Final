...
//	
//	@Test
//	public void checkUserNameAvailabilityException_Test() throws Exception 
//	{
//		
//		UserProfileResponse userProfileResponse=new UserProfileResponse(HttpStatus.BAD_REQUEST,"validation failed");
//		
...
//	{
//		userProfileRequest=new UserProfileRequest((long) 1, "mohan123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","Y","Y","Y","N");
//		
//		UserProfileResponse userProfileResponse=new UserProfileResponse(HttpStatus.BAD_GATEWAY,"User Not Logged In");
//		
...
//		.andExpect(( content().contentType(MediaType.APPLICATION_JSON)))
//		.andExpect((jsonPath("$.httpStatus").value("BAD_GATEWAY")))
//		.andExpect((jsonPath("$.response").value("User Not Logged In")));
//	}
//	
//	@Test
//	public void updateProfileException_Test() throws Exception 
//	{
//		userProfileRequest=new UserProfileRequest((long) 1, "mohan123","ramvicky@456","kumar","rahul.kumar@gmail.com","19/08/1999","983749213","rkv street","chennai","TamilNadu","India","638142","Y","Y","Y","N");
//		
